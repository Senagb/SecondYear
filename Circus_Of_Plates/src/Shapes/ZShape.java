...
public class ZShape extends shapes {
	public ZShape(int length, int height, Color color) {
		super(color);
	}
	...
	public ZShape() {
		...
		r2 = (Rectangle2D) new Rectangle(xPos + DIMENSION, yPos, DIMENSION,
				DIMENSION);
		r3 = (Rectangle2D) new Rectangle(xPos + DIMENSION, yPos + DIMENSION,
				DIMENSION, DIMENSION);
		r4 = (Rectangle2D) new Rectangle(xPos + (2 * DIMENSION), yPos
	...
	public void updateFigures() {
		{
			...
			r3.setRect(xPos + DIMENSION, yPos - DIMENSION, DIMENSION, DIMENSION);
