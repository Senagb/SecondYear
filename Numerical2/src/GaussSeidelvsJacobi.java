...
public class GaussSeidelvsJacobi {
	...
	public boolean rearrange(double[][] a) {
	...
	public static void main(String[] args) {
		double[] output = { 1, 28, 76 };
		double currentX[] = { 1, 0, 1 };
		double[][] system = { { 12, 3, -5 }, { 1, 5, 3 }, { 3, 7, 13 } };
		GaussSeidelvsJacobi gsj = new GaussSeidelvsJacobi(100, .001, true,
